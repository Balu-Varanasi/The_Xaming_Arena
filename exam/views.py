...
from The_Xaming_Arena.exam.forms import AnswerForm
from The_Xaming_Arena.exam.forms import BaseAnswerFormSet
...
def view_questions(request, sub_code, template_name='view_questions.html'):
    ...
    return render_to_response(template_name,
                              RequestContext(request, {"questions": questions})
                              )
...
@csrf_protect
@login_required
def start_exam(request, sub_code, template_name='start_exam.html',
               answer_form=formset_factory(AnswerForm,
                                           formset=BaseAnswerFormSet,
                                           extra=10),
               current_app=None, extra_context=None,
               after_exam='exam_complete.html'):
